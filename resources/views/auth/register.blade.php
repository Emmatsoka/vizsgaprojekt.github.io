...
<x-guest-layout>
    ...
    <form method="POST" action="{{ route('register') }}" id="regisztraciosform">
        ...
        <div class="block mt-4 align-items-center" id="captcha">
        ...
        <div class="block mt-4 ">
            <label for="gdpr" class="inline-flex items-center">
                ...
                <span class="ms-2 text-sm text-gray-600">Elolvastam, és elfogadom a <b><a href="{{url('adatvedelem')}}">Wesoc Adatvédelmi Szabályzatot</a></b>.</span>
